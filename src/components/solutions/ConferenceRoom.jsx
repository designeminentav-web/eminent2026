    ...
    <section className="relative overflow-hidden bg-gradient-to-br from-[#071028] via-[#0B1736] to-[#12254A] text-white py-20 px-6">
      ...
      <div className="relative z-10 max-w-7xl mx-auto grid lg:grid-cols-2 gap-14 items-center">
        ...
        >
          ...
          >
            Enhance meetings and corporate communication with advanced
            conference room solutions from Eminent Audio Visual. Our systems
            are designed to deliver crystal-clear audio, seamless connectivity,
            and intelligent integration for productive and professional
          ...
          <div className="grid sm:grid-cols-3 gap-4 mb-10">
            ...
            {[
              {
                title: "Clear Audio",
                desc: "Seamless voice communication for meetings.",
              },
              {
                title: "Noise Control",
                desc: "Distraction-free conferencing experience.",
              },
              {
                title: "Smart Integration",
                desc: "Easy connectivity with modern AV systems.",
              },
            ].map((item, index) => (
              <motion.div
                key={index}
