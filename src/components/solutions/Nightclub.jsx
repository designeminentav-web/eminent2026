    ...
    <section className="relative overflow-hidden bg-gradient-to-br from-[#071028] via-[#0B1736] to-[#12254A] text-white py-20 px-6">
      ...
      <div className="relative z-10 max-w-7xl mx-auto grid lg:grid-cols-2 gap-14 items-center">
        ...
        >
          ...
          >
            Night Clubs & <span className="text-blue-500">Bars</span>
          </motion.h1>
          ...
          >
            Create electrifying nightlife experiences with premium audio
            solutions from Eminent Audio Visual. Designed for clubs, lounges,
            and bars, our systems deliver deep bass, immersive sound, and
            dynamic performance that keeps the energy alive all night long.
          </motion.p>
          ...
          <div className="grid sm:grid-cols-3 gap-4 mb-10">
            ...
            {[
              {
                title: "Heavy Bass",
                desc: "Deep and powerful low-frequency performance.",
              },
              {
                title: "Party Sound",
                desc: "High-energy audio for immersive nightlife.",
              },
              {
                title: "Lighting Sync",
                desc: "Seamless audio and lighting integration.",
              },
            ].map((item, index) => (
              <motion.div
                key={index}
          ...
          >
            ...
            <Link
              to="/solutions/restaurants-cafes"
              className="
