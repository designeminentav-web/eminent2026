...
const CaseStudy = () => {
  ...
  return (
    <>
      ...
      <section 
        className="min-h-screen bg-gradient-to-b from-[#071028] via-[#0B1736] to-[#12254A] py-20 px-6 text-white overflow-hidden"
              ...
              >
                <div className="overflow-hidden h-72">
                  <img
                    src={item.img}
                    alt={item.title}
                    // SPEED OPTIMIZATION (Jab uncomment hoga, fast chalega)
